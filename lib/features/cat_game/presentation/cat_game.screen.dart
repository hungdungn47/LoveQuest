        ...
        actions: [
          Padding(
            ...
            child: Obx(
                  () => Row(
                children: [
                  Text('🖤 ${controller.blackPoints.value}', style: const TextStyle(fontSize: 20)),
                  const SizedBox(width: 16),
                  Text('🧡 ${controller.orangePoints.value}', style: const TextStyle(fontSize: 20)),
                ],
              ),
            ),
          ),
          ...
          children: [
            ...
            Positioned(
              ...
              child: GestureDetector(
                onTap: () => controller.animateCat(
                  isOrange: false,
                  onWin: () => _showWinnerDialog('Black Cat'),
                ),
                child: Container(
                  width: 80,
                  height: 80,
            ...
            Positioned(
              ...
              child: GestureDetector(
                onTap: () => controller.animateCat(
                  isOrange: true,
                  onWin: () => _showWinnerDialog('Orange Cat'),
                ),
                child: Container(
                  width: 80,
                  height: 80,
